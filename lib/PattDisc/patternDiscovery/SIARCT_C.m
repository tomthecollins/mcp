function [SIARCT_Coutput, runtime, FRT] = SIARCT_C(D, r,...
...
SIARCT_Coutput = categoriseRatedPatternsBySimilarity(SIARCToutput,...
  ratingField, [], similarThresh, similarFunc, similarParam);
